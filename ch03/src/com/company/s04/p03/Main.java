 ...
 * Override -> 덮어 씌운다, 해킹해서 먼가 달라지게 한다
...
class Student extends Person {
    @Override // 이렇게 적어주는 것이 관례. 필수는 아님(문법 오류는 아님)
    public void writeCode() {
...
class Developer extends Person {
    ...
    public void writeCode() {
        System.out.println("아무 코드나 일단 적어 보았다.");
        System.out.println("코드 작성이 하기 싫어서 하지 않닸다.");
    }
...
public class Main {
    public static void main(String[] args) {
        ...
        Person [] people = new Person[] {new Developer(), new Student()}; // people 은 Person 의 array이다. array 는 똑같은 자료형만 가질수 있다.
